        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <a title="new" href="{{ route('admin.admin_services.create') }}"
                    ...
                    <table class="table table-hover" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.admin_services.edit', $item->id) }}"
                                        class="btn btn-info py-1 btn-icon float-start">
                                        <i class="ti-pencil"></i>
                                    </a>

                                    <form method="post" action="{{ route('admin.admin_services.destroy', $item->id) }}">
                                        @csrf
                                        @method('DELETE')
